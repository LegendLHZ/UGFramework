...
namespace UnityEngine.UI.Editor
{
    ...
    public class ScrollViewEditor : ScrollRectEditor
    {
        ...
        private SerializedProperty leftAndTopBound;
        private SerializedProperty rightAndBottomBound;
        private SerializedProperty space; 
        private SerializedProperty snap;
        private SerializedProperty visibleRectTransform;
        ...
        protected override void OnEnable()
        {
            ...
            this.leftAndTopBound = this.serializedObject.FindProperty("leftAndTopBound");
            this.rightAndBottomBound = this.serializedObject.FindProperty("rightAndBottomBound");
            this.space = this.serializedObject.FindProperty("space");
            
            snap = serializedObject.FindProperty("snap");
            visibleRectTransform = serializedObject.FindProperty("visibleRectTransform");
        }
        ...
        protected virtual void DrawConfigInfo()
        {
            ...
            EditorGUILayout.PropertyField(leftAndTopBound);
            EditorGUILayout.PropertyField(rightAndBottomBound);
            ...
            EditorGUILayout.PropertyField(visibleRectTransform);
        }
